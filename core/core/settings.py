...
SECRET_KEY = config(
    "SECRET_KEY",
    default="django-insecure-p58l@s92)c-_vl6m3p3z#e9+$e17x$2q(od!-6902j^lyg161m",
)
...
# Melipayamak (replaces Kavenegar for OTP SMS)
MELIPAYAMAK_USERNAME = config("MELIPAYAMAK_USERNAME")
MELIPAYAMAK_PASSWORD = config("MELIPAYAMAK_PASSWORD")
MELIPAYAMAK_SENDER_NUMBER = config("MELIPAYAMAK_SENDER_NUMBER")
MELIPAYAMAK_BODY_ID = config("MELIPAYAMAK_BODY_ID", cast=int)
...
ZARINPAL_SANDBOX = config("ZARINPAL_SANDBOX", cast=bool, default=False)
